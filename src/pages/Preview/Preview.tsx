...
export function Preview() {
  ...
  return (
    <div className="bg-[#E5E5E5] flex flex-col">
      ...
      >
        <div id="CVElement" className="flex flex-row justify-center w-[100%] ">
          <div className="flex flex-col bg-[#F9F9F9] rounded-[5px] w-[70%]  pt-[42px] pl-[38px]  mb-[38px]">
            ...
            <div className="flex flex-col ">
              ...
              <span className="break-all w-[90%]">{resume}</span>
            </div>
            <div className="flex flex-col ">
              ...
              <span>
                {profExp.map((item) => (
                  <div>
                    ...
                    <div>
                      <span className="break-all w-[90%] flex">
                        {item.description}
                      </span>
                    </div>
                  </div>
